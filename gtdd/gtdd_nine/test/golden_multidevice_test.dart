...
import 'package:gtdd_nine/src/infrastructure/app_vars.dart';
import 'package:gtdd_nine/src/presentation/features/home/ui/sample_item_details_view.dart';
import 'package:gtdd_nine/src/presentation/features/home/ui/sample_item_list_view.dart';
import 'package:gtdd_nine/src/presentation/features/settings/ui/settings_view.dart';
import 'package:gtdd_nine/src/presentation/themes/my_app_themedata.dart';
...
void main() {
  ...
  group(
    ...
    () {
      ...
      testGoldens(
        'DeviceBuilder-Detail-Screen-base',
        (WidgetTester tester) async {
          final builder = DeviceBuilder()
            ..overrideDevicesForAllScenarios(
              devices: [
            ...
            ..addScenario(
              ...
              name: 'Sample Detail Item View  Base',
            );
          ...
          await screenMatchesGolden(
            tester,
            "sample item view multiple screens",
          );
        },
      );
