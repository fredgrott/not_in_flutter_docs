...
Typography materialTypography = Typography(
  black: materialBlackTextTheme,
  white: materialWhiteTextTheme,
  englishLike: materialEnglishLikeTextTheme,
  dense: materialDenseTextTheme,
  tall: materialTallTextTheme,
);

TextTheme materialBlackTextTheme = TextTheme(
...
TextTheme materialWhiteTextTheme = TextTheme(
  // ignore: avoid_redundant_argument_values
  headline1: TextStyle(
...
TextTheme materialEnglishLikeTextTheme = const TextTheme(
  headline1: TextStyle(
...
TextTheme materialDenseTextTheme = const TextTheme(
  headline1: TextStyle(
...
TextTheme materialTallTextTheme = const TextTheme(
  headline1: TextStyle(
