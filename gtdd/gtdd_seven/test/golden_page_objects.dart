...
class SampleItemListViewPageObject extends PageObject {
  ...
  Finder get listView =>
      find.descendant(of: this, matching: find.byKey(const Key('ListView')),);

  Finder get listTile =>
      find.descendant(of: this, matching: find.byType(ListTile),);

  Finder get listTileOne =>
      find.descendant(of: listTile, matching: find.byKey(const ValueKey(1)),);

  Finder get listTileTwo =>
      find.descendant(of: listTile, matching: find.byKey(const ValueKey(2)),);

  Finder get listTileThree =>
      find.descendant(of: listTile, matching: find.byKey(const ValueKey(3)),);
}
